...
function(request) {navbarPage(
  ...
  mainPanel(
    ...
    conditionalPanel(
      ...
      br(),
      br(),
      numericInput("logo_cluster", "Select cluster to show:", 5,  min = 1, max = 128, width="140px"),
      br(),
      plotOutput("logocl"),
      br(),
    ...
    conditionalPanel(
      ...
      br(),
      br(),
      numericInput("bar_cluster", "Select cluster to show:", 5,  min = 1, max = 116, width="140px"),
    ...
    conditionalPanel(
      ...
      br(),
      br(),
      numericInput("amino_cluster", "Select cluster to show:", 5,  min = 0, max = 128, width="140px"),
      br(),
      tableOutput('aminocl')
    ),
    ...
    conditionalPanel(
      ...
      br(),
      br(),
      numericInput("aminoide_cluster", "Select cluster to show:", 5,  min = 1, max = 128, width="140px"),
    ...
    conditionalPanel(
      ...
      br(),
      br(),
      numericInput("opt1_cluster", "Select cluster to show:", 5,  min = 0, max = 128, width="140px"),
      br(),
      textOutput('opt1cl')
    ),
    ...
    conditionalPanel(
      ...
      br(),
      br(),
      numericInput("opt2_cluster", "Select cluster to show:", 5,  min = 1, max = 128, width="140px"),
      br(),
      textOutput('opt2cl')
    ),
