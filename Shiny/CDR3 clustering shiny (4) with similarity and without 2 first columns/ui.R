...
function(request) {navbarPage(
  ...
  mainPanel(
    ...
    conditionalPanel(
      ...
      br(),
      br(),
      numericInput("tree_level", "Select max level of the tree:", 5,  min = 1, max = 17, width="140px"),
      br(),
      grVizOutput("tre", width = "2000px", height = "1000px")
    ),
    ...
    conditionalPanel(
      ...
      br(),
      br(),
      numericInput("logo_level", "Select level to show:", 5,  min = 1, max = 17, width="140px"),
      br(),
      plotOutput("logolev"),
      br(),
    ...
    conditionalPanel(
      ...
      br(),
      br(),
      numericInput("logo_cluster", "Select cluster to show:", 5,  min = 1, max = 126, width="140px"),
      br(),
      plotOutput("logocl"),
      br(),
    ...
    conditionalPanel(
      ...
      br(),
      br(),
      numericInput("bar_level", "Select level to show:", 5,  min = 1, max = 16, width="140px"),
    ...
    conditionalPanel(
      ...
      br(),
      br(),
      numericInput("bar_cluster", "Select cluster to show:", 5,  min = 1, max = 114, width="140px"),
    ...
    conditionalPanel(
      ...
      br(),
      br(),
      numericInput("amino_level", "Select level to show:", 5,  min = 1, max = 17, width="140px"),
      br(),
    ...
    conditionalPanel(
      ...
      br(),
      br(),
      numericInput("amino_cluster", "Select cluster to show:", 5,  min = 0, max = 126, width="140px"),
      br(),
      tableOutput('aminocl')
    ),
    ...
    conditionalPanel(
      ...
      br(),
      br(),
      numericInput("aminoide_level", "Select level to show:", 5,  min = 1, max = 17, width="140px"),
    ...
    conditionalPanel(
      ...
      br(),
      br(),
      numericInput("aminoide_cluster", "Select cluster to show:", 5,  min = 1, max = 126, width="140px"),
    ...
    conditionalPanel(
      ...
      br(),
      br(),
      numericInput("opt1_level", "Select level to show:", 5,  min = 1, max = 17, width="140px"),
      br(),
      textOutput('opt1lev')
    ),
    ...
    conditionalPanel(
      ...
      br(),
      br(),
      numericInput("opt1_cluster", "Select cluster to show:", 5,  min = 0, max = 126, width="140px"),
      br(),
      textOutput('opt1cl')
    ),
    ...
    conditionalPanel(
      ...
      br(),
      br(),
      numericInput("opt2_level", "Select level to show:", 5,  min = 1, max = 17, width="140px"),
      br(),
      textOutput('opt2lev')
    ),
    ...
    conditionalPanel(
      ...
      br(),
      br(),
      numericInput("opt2_cluster", "Select cluster to show:", 5,  min = 1, max = 126, width="140px"),
      br(),
      textOutput('opt2cl')
    ),
    ...
    conditionalPanel(
      ...
      br(),
      br(),
      numericInput("net_level", "Select level to show:", 2,  min = 0, max = 17, width="140px"),
      ...
      numericInput("thr_value", "Select threshold value:", 2,  min = 1, max = 17, width="140px"),
      br(),
