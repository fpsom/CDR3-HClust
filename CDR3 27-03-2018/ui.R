...
function(request) {navbarPage(
  ...
  tabPanel("Home", value = "home",
          mainPanel(
            ...
            conditionalPanel(
              ...
              tags$div(style="display:inline-block;",numericInput("column_num", "Select columns to exclude from the algorithm [0 - value]:", 0,  min = 0, max = 20, width="140px")),
              tags$div(style="display:inline-block;",checkboxInput("thr_en", "Show Network using thresholds", FALSE)),
              ...
              tags$div(style="display:inline-block;",numericInput("thr_2", "Select threshold percentage for Identity or Similarity", 10,  min = 0, max = 100, width="140px")),
  ...
  tabPanel("Bookmark",value = "BookmarkTab",
          fluidPage(
            br(),
            br(),
            br(),
            br(),
             bookmarkButton(),
             actionButton("showPreviousSessions", "showPreviousSessions"),
