...
# Example - cho = "Identity" - BarLev(2)
# Create the grid (we need to miximize the pop-up window in order to have a perfect fit)  -  get( getOption( "device" ) )()
...
# Fasta file - write.fasta(aa2, names= FALSE ,file = sprintf("Level.%d", level))
# Example - AminoLev(5)
...
# Fasta file - write.fasta(aa, names= FALSE ,file = sprintf("Cluster.%d", clust))
# Example - AminoCl(5)
...
#Example - Opt2New(AminoCl(5))


######################################## Visualization 5e - OptLev (server of Shiny) ########################################
typeopt = "Identity"
OptLev <- function(lev){
  xN <- as.Node(df)
  t1 = which(lastlist$clep == lev)
...
# Example - cho = "Identity" - idenlev(5)
...
# Example - net_sil = FALSE -Netw(3,0,"Distance","Whole",df,lastlist,Clus,7,10,FALSE)